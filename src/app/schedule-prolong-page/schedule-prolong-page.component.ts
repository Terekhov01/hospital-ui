...
import { ScheduleTableDataSource } from '../schedule-table-page/schedule-table-page.data-source';
import { SchedulePatternDataSource } from './schedule-prolong-page.data-source';
import { Interval, ScheduleDayPattern, TimeRounded } from './schedule-prolong-page.i-raw-data';
...
export class ScheduleProlongPageComponent implements OnInit {
  ...
  onSubmitClicked(): void
  {
    ...
    let response = this.scheduleService.postDoctorSchedulePattern(tableData);
